...
var app = new Vue({
  ...
  computed: {
        resource: function() {
            return this.$resource('https://lifeportal.ml/api/v1/youtubes/search?category=films&page='+this.current_page_films)
        },
        resource2: function() {
            return this.$resource('https://lifeportal.ml/api/v1/youtubes/search?category=mults&page='+this.current_page_films2)
        },
        resource3: function() {
