...
<head>
  ...
  <title>Рецепт House - контакты</title> 
          ...
          <div class="tm-top-header-inner">
            ...
            <nav class="tm-nav">
              <ul>
                  ...
                  <li><a href="/contact2" class="active">Контакты</a></li>
              </ul>
            </nav>   
          </div>           
        </div>    
    ...
    <section class="tm-welcome-section">
      <div class="container tm-position-relative">
        ...
        <div class="row tm-welcome-content">
          <h2 class="white-text tm-handwriting-font tm-welcome-header"><img src="/assets/recipe-house/img/header-line.png" alt="Line" class="tm-header-line">&nbsp;Контакты&nbsp;&nbsp;<img src="/assets/recipe-house/img/header-line.png" alt="Line" class="tm-header-line"></h2>
          <h2 class="gold-text tm-welcome-header-2">Рецепт House</h2>
          <p class="gray-text tm-welcome-description">Для связи с нами просто заполните ниже простую акету, обязательно указав ваше имя, настоящий email адрес, контактный номер телефона и сам текст обращения.</p>
          <a href="#main" class="tm-more-button tm-more-button-welcome">Контакты</a>      
        </div>
    ...
    <div class="tm-main-section light-gray-bg">
      <div class="container" id="main">
        <section class="tm-section row">
          <h2 class="col-lg-12 margin-bottom-30">Напишите нам</h2>
          <form action="#" method="post" class="tm-contact-form">
            <div class="col-lg-6 col-md-6">
              ...
              <div class="form-group">
                <input type="tel" id="contact_subject" class="form-control" placeholder="Номер телефона" />
              </div>
              <div class="form-group">
                <textarea id="contact_message" class="form-control" rows="6" placeholder="Текст обращения"></textarea>
              </div>
              <div class="form-group">
