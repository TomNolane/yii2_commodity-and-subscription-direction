...
var app = new Vue({
  ...
  computed: {
        resource: function() {
            return this.$resource('https://lifeportal.ml/api/v1/youtubeens/search?category=films&page='+this.current_page_films)
        },
        resource2: function() {
            return this.$resource('https://lifeportal.ml/api/v1/youtubeens/search?category=cartoons&page='+this.current_page_films2)
        },
        resource3: function() {
            return this.$resource('https://lifeportal.ml/api/v1/youtubeens/search?category=music&page='+this.current_page_films3)
        }
    }, 
  methods: {
