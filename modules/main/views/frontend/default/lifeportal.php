...
?>
      ...
      $('.gallery-4').magnificPopup({
        ...
        iframe: {
          markup: '<div class="mfp-iframe-scaler">' +
            ...
            '<iframe class="mfp-iframe" frameborder="0" allowfullscreen></iframe>' +
            '<div class="mfp-title">Some caption</div>' +
            '</div><script>(adsbygoogle = window.adsbygoogle || []).push({google_ad_client: "ca-pub-1233613285194868", enable_page_level_ads: true});</script>'
        },
        callbacks: {
          markupParse: function (template, values, item) {
            values.title = item.el.attr('title');
  ...
  <script>
    ...
    Vue.component("search-component", {
      template: `<div class="input-group"><input v-model="data" id="search1" class="form-control" placeholder="Search ..." @keyup="findFilms"><div class="input-group-addon" ><i class="fa fa-search"></i></div></div>`,
      data: function () {
        return {
          data: ''
        }
    ...
    Vue.component("search-component2", {
      template: `<div class="input-group"><input v-model="data2" id="search2" class="form-control" placeholder="Search ..." @keyup="findFilms2"><div class="input-group-addon" ><i class="fa fa-search"></i></div></div>`,
      data: function () {
        return {
          data2: ''
        }
    ...
    Vue.component("search-component3", {
      template: `<div class="input-group"><input v-model="data3" id="search3" class="form-control" placeholder="Search ..." @keyup="findFilms3"><div class="input-group-addon" ><i class="fa fa-search"></i></div></div>`,
      data: function () {
        return {
          data3: ''
        }
      ...
      methods: {
        ...
        getAllPosts2: function () {
          ...
          this.resource2.get().then(function (response) {
            ...
            all_pages_films2 = (typeof dd.map['x-pagination-page-count'] != "undefined") ? dd2.map['x-pagination-page-count'][0] : dd2.map['X-Pagination-Page-Count'][0] ;
            _current_page_films2 = (typeof dd.map['x-pagination-current-page'] != "undefined") ? dd2.map['x-pagination-current-page'][0] : dd2.map['X-Pagination-Current-Page'][0] ;
        ...
        getAllPosts3: function () {
          ...
          this.resource3.get().then(function (response) {
            ...
            all_pages_films = (typeof dd3.map['x-pagination-page-count'] != "undefined") ? dd3.map['x-pagination-page-count'][0] : dd3.map['X-Pagination-Page-Count'][0] ;
            _current_page_films = (typeof dd3.map['x-pagination-current-page'] != "undefined") ? dd3.map['x-pagination-current-page'][0] : dd3.map['X-Pagination-Current-Page'][0] ;
