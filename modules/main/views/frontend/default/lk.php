...
<body>
    ...
    <div class="wrap_block_success">
        ...
        <br><br>
            <?php if($lk != "0")
            echo "<h2>Поздравляем! Ваш заказ (№ $lk) принят!</h2>";
            else echo '<h2>Поздравляем! Ваш заказ принят!</h2>';?>
            ...
            <h1 style="color:#FF0000; text-align: center;">Спасибо что выбрали нас!</h1><br><br>
            <center><button type="button" class="btn btn-success btn-lg" onClick="document.location = 'http://'+document.location.host">Вернуться к описанию товара</button></center>
        </div>
