...
<head>
  ...
  <title>Рецепт House - главная</title> 
...
<!--         
        <section class="tm-section row">
          <div class="col-lg-12 tm-section-header-container">
            <h2 class="tm-section-header gold-text tm-handwriting-font"><img src="/assets/recipe-house/img/logo.png" alt="Logo" class="tm-site-logo"> ТОП рецепты (май)</h2>
            <div class="tm-hr-container"><hr class="tm-hr"></div>
          </div>          
          <div class="col-lg-12 tm-special-container margin-top-60">
            <div class="tm-special-container-left"> 
                <div class="tm-special-img-container">
                  <img src="/assets/recipe-house/img/special-1.jpg" alt="Special" class="tm-special-img img-responsive">  
                  <a href="#">
            ...
            <div class="tm-special-container-right">  
              <div>
                <div class="tm-special-item">
                  <div class="tm-special-img-container">
                    <img src="/assets/recipe-house/img/special-2.jpg" alt="Special" class="img-responsive">  
                    <a href="#">
                      <div class="tm-special-description">
              ...
              <div class="tm-special-container-lower">
                <div class="tm-special-item">
                  <div class="tm-special-img-container">
                    <img src="/assets/recipe-house/img/special-3.jpg" alt="Special" class="img-responsive">  
                    <a href="#">
                      <div class="tm-special-description">
                ...
                <div class="tm-special-item">
                  <div class="tm-special-img-container">
                    <img src="/assets/recipe-house/img/special-4.jpg" alt="Special" class="img-responsive">  
                    <a href="#">
                      <div class="tm-special-description">
                        <p>Quisque rutrum.</p>
                      </div>
