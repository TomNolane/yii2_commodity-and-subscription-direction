...
timeout:d.timeout,withCredentials:!0},f=a.b.Ha||!1,g=fg(f);Object.assign(e.headers,g);var h="",l=a.b.Ga;l&&(h=l);e.headers.Authorization&&!h&&(e.headers["x-origin"]=window.location.origin);h=("//youtube.com/youtubei/"+a.b.innertubeApiVersion+"/"+b)+"?alt=json&key="+a.b.innertubeApiKey;var m;if(d.retry&&S("retry_web_logging_batches")&&(m=kg(b,c,g,f))){var t=e.onSuccess,O=e.ma;e.onSuccess=function(a,b){lg(m);t(a,b)};
...
var sg=1;function tg(){var a=Q("ROOT_VE_TYPE",void 0),b;a?b=new qg({veType:a,youtubeData:void 0}):b=null;return b}
...
mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getVideoContentRect&&(a.videoContentRect=this.b.getVideoContentRect());this.b.getProgressState&&(a.progressState=this.b.getProgressState());this.b.getStoryboardFormat&&(a.storyboardFormat=this.b.getStoryboardFormat());Yh(this,a)};
